...
class BookingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "POST #create_pending keeps precise_date search context on redirect when slot is unavailable" do
    travel_to Time.zone.local(2026, 3, 15, 8, 0, 0) do
      slot = Time.zone.local(2026, 3, 16, 10, 0, 0)
  ...
  test "POST #create_pending keeps first_available search context on redirect when slot is unavailable" do
    travel_to Time.zone.local(2026, 3, 15, 8, 0, 0) do
      slot = Time.zone.local(2026, 3, 16, 10, 0, 0)
